...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'agelivasteras-leads' ),
				'storm'       => __( 'Storm or hail damage', 'agelivasteras-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'agelivasteras-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'agelivasteras-leads' ),
				'not-sure'    => __( 'Vet inte än', 'agelivasteras-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'agelivasteras-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'agelivasteras-leads' ),
				'research' => __( 'Jag kollar bara priser', 'agelivasteras-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'agelivasteras-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'agelivasteras-leads' ),
		'contacted' => __( 'Kontaktad', 'agelivasteras-leads' ),
		'quoted'    => __( 'Quote sent', 'agelivasteras-leads' ),
		'won'       => __( 'Won', 'agelivasteras-leads' ),
		'lost'      => __( 'Lost', 'agelivasteras-leads' ),
		'spam'      => __( 'Misstänkt spam', 'agelivasteras-leads' ),
	);
}
